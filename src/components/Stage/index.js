...
const Stage = React.forwardRef(({ lose, restartClick, map, player, hint, status, paused, ...others }, ref) => {
	...
	return (
		<div>
			<Game portrait={portrait}>
				...
				{map && (
					<StyledStage ref={ref || stageRef} {...others} theme3d={theme3d} pixelSize={pixelSize}>
						{map.map((row, y) => (
